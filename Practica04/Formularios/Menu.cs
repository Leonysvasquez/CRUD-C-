...
namespace Practica04
{
    public partial class Menu : Form
    {
        ...
        private void btnActivos_Click(object sender, EventArgs e)
        {
            ...
            nodo.Nodes.Add("frmPosicion", "Posicion", 9);
        ...
        private void btnFmrPosicion_Click_1(object sender, EventArgs e)
        {
            Form formulario = new frmPosicion();
            formulario.Show();
          
        }

        private void btnFmrFabrica_Click(object sender, EventArgs e)
        {
            Form formulario = new frmFabrica1();
            formulario.Show();
        }

        private void btnFmrDepartamento_Click(object sender, EventArgs e)
        {
            Form formulario = new frmDepart();
            formulario.Show();
        }

        private void btnVENTDEP_Click_1(object sender, EventArgs e)
        {
            Form formulario_dept = new frmVENDEPTO();
            formulario_dept.ShowDialog();
        }

        private void btnConsultaPosiciones_Click(object sender, EventArgs e)
        {
            Form formulario_dept = new FmrVENTPosicion();
            formulario_dept.ShowDialog();
        }

        private void btnConsultaFabrica_Click(object sender, EventArgs e)
        {
            Form formulario_dept = new frmVENFABRICA();
            formulario_dept.ShowDialog();
        }

        private void btnCLocalidad_Click(object sender, EventArgs e)
        {
            Form formulario_dept = new VENTLocalidad();
            formulario_dept.ShowDialog();
        }

        private void btnLocalidad_Click(object sender, EventArgs e)
        {
            Form formulario = new FmrLocalidad();
            formulario.Show();
        }
        ...
        {
            Form formularioCliente = new frmCliente();
            formularioCliente.ShowDialog();
        }

        private void TIPDOC_Click(object sender, EventArgs e)
        {
            Form formularioTipDoc = new TipoDocumento();
            formularioTipDoc.ShowDialog();
        }

        private void CLASIFICADOC_Click(object sender, EventArgs e)
        {
            Form formularioClasificaDoc = new ClasificaDocumento();
            formularioClasificaDoc.ShowDialog();
        }

        private void CLASIFICADOCCTE_Click(object sender, EventArgs e)
        {
          Form formularioCte = new frmClasificaCte();
         formularioCte.ShowDialog();
