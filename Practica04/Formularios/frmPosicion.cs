        ...
        {
            {
                ...
                // creo el objeto frm y se le asigna el formulario frmVENDEPTO al objeto
                FmrVENTPosicion frm = new FmrVENTPosicion();
                ...
                if (res == DialogResult.OK)           // aqui pregunta que si res es igual a ok ejecute el siguiente codigo
                {
                    txtPosicion.Text = frm.varf1; // txtdepartamento se le asignara el valor contenido en la variable varf1
                    txtNombrePosicion.Text = frm.varf2; // txtdepartamento se le asignara el valor contenido en la variable varf2
                }
            }
        }
    }
