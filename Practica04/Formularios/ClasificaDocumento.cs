...
using Practica04.Formularios;

namespace Practica04
{
    public partial class ClasificaDocumento : Form
    {
         //string varf1; // txtdepartamento se le asignara el valor contenido en la variable varf1
         //string varf2;

        public ClasificaDocumento()
        {
            InitializeComponent();
        ...
        private void buscar_datos()
        {
            ...
            SqlCommand cmmnd = new SqlCommand("    SELECT Clasifica ,Descripcion,  " +
                                              " FROM Clasifica_Cte , SECUENCIA " +
        ...
        private void btnConsultaCD_Click(object sender, EventArgs e)
        {
            ...
            txtClase.Focus();  // el curso se queda en el textbox txtdepartamento
             ...
             VENTCLASIFICADOC frm = new VENTCLASIFICADOC ();
