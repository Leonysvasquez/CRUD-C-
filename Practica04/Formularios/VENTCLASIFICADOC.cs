...
{
    public partial class VENTCLASIFICADOC : Form
    {
        ...
        public VENTCLASIFICADOC()
        {
            InitializeComponent();
        }
        

        private void VENTCLASIFICADOC_Load(object sender, EventArgs e)
        {
        ...
        private void VENTCLASIFICADOC_KeyDown(object sender, KeyEventArgs e)
        {
