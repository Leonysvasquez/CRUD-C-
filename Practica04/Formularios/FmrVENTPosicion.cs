...
{
    public partial class FmrVENTPosicion : Form
    {
        public string varf1;
        public string varf2;

        public FmrVENTPosicion()
        {
            InitializeComponent();
            this.StartPosition = FormStartPosition.CenterScreen;
        }

        private void FmrVENTPosicion_Load(object sender, EventArgs e)
        {
        ...
        private void FmrVENTPosicion_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void BuscarDatos()
        {
            ...
            SqlCommand sqCmd = new SqlCommand("SELECT IDposicion,NombreDePosicion, Fabrica, Departamento "
                                              + "  FROM POSICIONES "
                                              + " WHERE IDposicion  LIKE '%" + txtBuscar.Text + "%'"
